...
This document provides guidance for working with code in the Terminus project.

If you are not sure, do not guess, just say that you don't know or ask clarifying questions. Don't just copy code that follows the same pattern as other code.  Don't rely on just anmes to guess it's function, evaulate the code based on implementation and usage.
